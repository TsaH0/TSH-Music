...
export default function MusicUI() {
  ...
  return (
    <div className="min-h-screen w-full bg-black flex items-center justify-center p-2 sm:p-4 lg:p-6">
      <div className="w-full max-w-[1600px] bg-linear-to-br from-zinc-900 via-black to-zinc-900 border border-purple-900/50 rounded-xl sm:rounded-2xl lg:rounded-3xl p-4 sm:p-6 lg:p-12 shadow-2xl shadow-purple-900/20">
        {/* Header */}
        <div className="text-center mb-6 sm:mb-8 lg:mb-12 pb-4 sm:pb-6 border-b border-purple-900/30">
          <h1 className="text-3xl sm:text-5xl lg:text-7xl font-bold bg-linear-to-r from-purple-400 via-purple-500 to-purple-600 bg-clip-text text-transparent tracking-widest uppercase">
            TSH Music Chamber
          </h1>
        </div>
